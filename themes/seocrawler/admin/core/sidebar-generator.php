		...
		class gdlr_core_sidebar_generator{
			...
			function __construct( $sidebar_args = array() ){
				...
				$this->footer_widgets = array(
					array( 'name'=>esc_html__('Footer 1', 'seocrawler'), 'id'=>'footer-1', 'description'=>esc_html__('Footer Column 1', 'seocrawler') ), 
					array( 'name'=>esc_html__('Footer 2', 'seocrawler'), 'id'=>'footer-2', 'description'=>esc_html__('Footer Column 2', 'seocrawler') ), 
					array( 'name'=>esc_html__('Footer 3', 'seocrawler'), 'id'=>'footer-3', 'description'=>esc_html__('Footer Column 3', 'seocrawler') ), 
					array( 'name'=>esc_html__('Footer 4', 'seocrawler'), 'id'=>'footer-4', 'description'=>esc_html__('Footer Column 4', 'seocrawler') )
				);
			...
			function register_sidebar_widget(){
				...
				$sidebar_args['name'] = __('Preset', 'seocrawler');
				$sidebar_args['id'] = 'gdlr-core-sidebar-preset';
				$sidebar_args['description'] = esc_html__('Another Custom widget area', 'seocrawler');
				...
				foreach ( $this->sidebars as $sidebar ){
					...
					$sidebar_args['description'] = esc_html__('Custom widget area', 'seocrawler');
