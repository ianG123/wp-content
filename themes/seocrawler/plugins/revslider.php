<?php
	...
	add_filter('revslider_getUsedFonts', 'seocrawler_revslider_getUsedFonts');
	if( !function_exists('seocrawler_revslider_getUsedFonts') ){
		function seocrawler_revslider_getUsedFonts( $used_font ){
