...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="seocrawler-single-article" >
		<?php
				...
				if( empty($post_format) ){
					if( $feature_image_pos == 'content' ){
						...
						if( !empty($feature_image) ){
							$thumbnail_size = seocrawler_get_option('general', 'blog-thumbnail-size', 'full');
			...
			wp_link_pages( array(
				'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'seocrawler' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span>',
				'link_after'  => '</span>',
				'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'seocrawler' ) . ' </span>%',
