<?php
	...
	foreach( $social_list as $social_key => $social_icon ){
		$social_link = seocrawler_get_option('general', 'top-bar-social-' . $social_key);
		...
		if( !empty($social_link) ){
			echo '<a href="' . esc_url($social_link) . '" target="_blank" class="seocrawler-top-bar-social-icon" title="' . esc_attr($social_key) . '" >';
